...
public class UmsAdminController {
    ...
    @ResponseBody
    public CommonResult getAdminInfo(Principal principal,@RequestParam(defaultValue = "1") Integer type) {
        if(principal==null){
        ...
        data.put("menus", roleService.getMenuList(umsAdmin.getId(),type));
